...
export class CreateChildrenPayloadDto {
  ...
  @ValidateNested()
  @Type(() => TutorContactDto)
  contacto_tutor: TutorContactDto;

  @IsArray()
  @ValidateNested({ each: true })
  @Type(() => ChildPersonDto)
  personas: ChildPersonDto[]; // 1..3
}
